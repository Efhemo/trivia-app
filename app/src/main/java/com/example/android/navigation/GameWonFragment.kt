...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        /*Toast.makeText(context, "numQuestions ${args?.numQuestion}, " +
                "numCorrect ${args?.numCorrect}", Toast.LENGTH_SHORT).show()*/
    ...
    private fun getShareIntent(): Intent {
        ...
        shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.share_success_text, args?.numQuestion, args?.numCorrect))
